...
import { type default as PrismaTypes, getDatamodel } from '#prisma-lib/pothos-prisma-types';
...
// No explicit return type: complex type inference.
...
export function createBuilder(prisma: PrismaClient) {
  const builder = new SchemaBuilder<{
    ...
    scopeAuth: {
      ...
      authScopes: context => ({ authenticatedCreator: context.creator != null })
    }
  });
