 ...
 * translatable to JSON but can be used to dynamically _avoid_ serialization of a field.
 *
...
export function optionallySerialized<T extends JsonValue>(
  ...
  // oxlint-disable-next-line typescript/no-redundant-type-constituents - branded sentinel documents intent, mirrors JsonObject
